...
class BinarySearchTree:
	...
	def printInorder(self, tNode:TreeNode):
		if tNode:
			self.printInorder(tNode.left)
			print(tNode.item, end=' ')
			self.printInorder(tNode.right)

	def printPostorder(self, tNode:TreeNode):
		if tNode:
			self.printPostorder(tNode.left)
			self.printPostorder(tNode.right)
			print(tNode.item, end=' ')

	def printPreorder(self, tNode:TreeNode):
		if tNode:
			print(tNode.item, end=' ')
			self.printPreorder(tNode.left)
			self.printPreorder(tNode.right)
